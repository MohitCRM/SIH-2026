  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center p-20 text-base-content/50">
        ...
        <p className="text-lg font-medium">Loading assigned applications...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto fade-in">
      ...
      <header className="mb-10">
        <h1 className="text-3xl font-bold mb-2 text-base-content">Nodal Officer Dashboard</h1>
        <p className="text-base-content/60 font-medium">Review and verify student applications for assigned schemes.</p>
      </header>
      ...
      <div className="stats shadow-sm w-full mb-10 border border-base-200">
        <div className="stat">
          ...
          <div className="stat-title font-bold uppercase tracking-wider text-xs">Pending Review</div>
          <div className="stat-value text-base-content">{applications.length}</div>
          <div className="stat-desc text-warning font-medium">Requires immediate action</div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-title font-bold uppercase tracking-wider text-xs">Approved Today</div>
          <div className="stat-value text-base-content opacity-70">0</div>
          <div className="stat-desc">Applications processed</div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-title font-bold uppercase tracking-wider text-xs">Assigned Institutes</div>
          <div className="stat-value text-base-content opacity-70">12</div>
          <div className="stat-desc text-info font-medium">2 new institutes added</div>
        </div>
      </div>
      ...
      <div className="card bg-base-100 border border-base-200 shadow-sm overflow-hidden rounded-xl">
        <div className="p-6 border-b border-base-200 flex justify-between items-center bg-base-200/50">
          <h2 className="text-lg font-bold text-base-content">Applications Requiring Verification</h2>
          <div className="badge badge-warning badge-outline font-bold p-3">
            {applications.length} Action Items
          </div>
        </div>
        ...
        {applications.length > 0 ? (
          ...
          <div className="p-16 text-center text-base-content/50">
            ...
            <h3 className="text-lg font-bold text-base-content/80 mb-1">All Caught Up!</h3>
            <p>There are no pending applications waiting for your verification right now.</p>
          </div>
        )}
      </div>
